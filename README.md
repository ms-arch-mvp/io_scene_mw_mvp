...
`scripts\import_simple.py` can be used for a quick start import, where `nif_folder` can be pointed to the output of Export Cells or any other folder containing NIF files.
